...
{ 
    ...
    public interface StoreService
    {
        ...
        /// <returns></returns>
        Task DeleteOrder(NancyContext context, long? orderId);
    ...
    {
        public virtual Task DeleteOrder(NancyContext context, long? orderId)
        {
        ...
        protected abstract Task DeleteOrder(long? orderId);
