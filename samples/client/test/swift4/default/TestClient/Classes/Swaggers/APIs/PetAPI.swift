...
open class PetAPI {
  ...
  "status" : "available"
    ...
    open class func findPetsByStatusWithRequestBuilder(status: [String]) -> RequestBuilder<[Pet]> {
        ...
        let requestBuilder: RequestBuilder<[Pet]>.Type = TestClientAPI.requestBuilderFactory.getBuilder()
  ...
  "message" : "message"
    ...
    open class func uploadFileWithRequestBuilder(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil) -> RequestBuilder<ApiResponse> {
        ...
        let requestBuilder: RequestBuilder<ApiResponse>.Type = TestClientAPI.requestBuilderFactory.getBuilder()
