...
open class UserAPI {
  ...
  "username" : "username"
    ...
    open class func getUserByNameWithRequestBuilder(username: String) -> RequestBuilder<User> {
        ...
        let requestBuilder: RequestBuilder<User>.Type = TestClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func loginUserWithRequestBuilder(username: String, password: String) -> RequestBuilder<String> {
        ...
        let requestBuilder: RequestBuilder<String>.Type = TestClientAPI.requestBuilderFactory.getBuilder()
