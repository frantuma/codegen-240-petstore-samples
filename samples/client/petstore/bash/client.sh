...
operation_parameters_collection_type["findPetsByStatus:::status"]="multi"
operation_parameters_collection_type["findPetsByTags:::tags"]="multi"
...
EOF
    ...
    echo -e "        * https://petstore.swagger.io/oauth/dialog"
    echo -e "      Scopes:"
...
print_findPetsByStatus_help() {
    ...
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}status${OFF} ${BLUE}[array[string]]${OFF} ${RED}(required)${OFF}${OFF} - Status values that need to be considered for filter${YELLOW} Specify as: status=value1 status=value2 status=...${OFF}" \
...
print_findPetsByTags_help() {
    ...
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tags${OFF} ${BLUE}[array[string]]${OFF} ${RED}(required)${OFF}${OFF} - Tags to filter by${YELLOW} Specify as: tags=value1 tags=value2 tags=...${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
